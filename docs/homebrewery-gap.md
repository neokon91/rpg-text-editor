...
- Import di plugin pack JSON esterni non versionati, con persistenza locale.
...
4. Validazione UX piu ricca per pack esterni: anteprima componenti, collisioni guidate e reset storage.
