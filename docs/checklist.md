...
- [x] Indicatore overflow pagine nella toolbar preview, con salto alla prima pagina da spezzare.
...
1. Suggerire o inserire page break assistiti partendo dall'indicatore overflow.
