...
- Comando `Break` per inserire `::pagebreak` prima della riga selezionata, utile dopo il salto da overflow.
...
- Scelta automatica piu precisa del punto di break e riduzione overflow residuo dopo l'inserimento.
