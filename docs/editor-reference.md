...
- Import pack JSON esterni non versionati dalla palette, con rimozione e persistenza locale.
...
- Validazione UX piu ricca per pack esterni: anteprima componenti, messaggi collisione dedicati e reset storage.
