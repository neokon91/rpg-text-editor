export function renderMarkdown(markdown, schema) {
...
function renderContainer(name, label, markdown, schema) {
  ...
  if (["monster", "spell", "magicitem", "npc", "location", "hazard"].includes(className)) {
    return renderRulesComponent(className, title, data, schema);
  }
  ...
  if (component) return renderSchemaComponent(component, title, data, schema);
...
function renderSchemaComponent(component, label, data, schema) {
...
function renderRulesComponent(className, label, data, schema) {
