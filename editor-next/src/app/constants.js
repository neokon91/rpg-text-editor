export const enabledPacksStorageKey = "rpg-text-editor:enabled-packs";
export const externalPacksStorageKey = "rpg-text-editor:external-packs";
export const workspaceStoragePrefix = "rpg-text-editor-next";
